  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse justify-content-center" style="font-size:20px;" id="navbarNavAltMarkup">
      ...
      <a class="nav-link" aria-current="page" href="upload.php" style="margin-left:450px;">Upload</a>
        ...
        <a class="nav-link active" href="feedback_data.php">&nbsp;&nbsp;&nbsp;Feedback</a>
    ...
    <h1 style="text-align:center;margin-top:50px;font-size:36px;">List of feedback data</h1> <br>
    <div class="container mt-2">
        <div class="row justify-content-center">
            <table class="table table-striped table-bordered table-hover" style="border:2px solid lightgray;">
                ...
                <tbody style="border:2px solid lightgray;text-align:center;font-size:17px;">
                    <?php
                        $con=mysqli_connect("localhost","root","","contact_detail");
                        $filterdata = "SELECT * FROM feedback_form";
