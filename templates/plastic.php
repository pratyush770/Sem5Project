...
$sql="SELECT * from product WHERE pcategory='Plastic' ";
...
<main>
<h2 class="text-center" style="font-family:'Poppins';">Plastic Products</h2>
  <?php
  while($row = mysqli_fetch_assoc($all_product)){ 
  ?>
  <div class="card">
      <div class="image">
      <a href="plastic_info?id=<?php echo $row['pid'];?>"><img src="../static/images/<?php echo $row['imgupload'];?>"></a>
      </div>
      <div class="caption">
