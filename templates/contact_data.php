...
<nav class="navbar navbar-expand-lg bg-danger border-bottom border-body" data-bs-theme="dark">
  <div class="container-fluid">
    ...
    <h1 style="text-align:center;margin-top:50px;font-size:36px;">List of contact data</h1> <br>
    <div class="container mt-2">
        <div class="row justify-content-center">
            <table class="table table-bordered table-hover table-striped" style="border:2px solid lightgray;">
                ...
                <tbody style="border:2px solid lightgray;text-align:center;font-size:17px;">
                    <?php
                        ...
                        $filterdata = "SELECT * FROM contact_form";
